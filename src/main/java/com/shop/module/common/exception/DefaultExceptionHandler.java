package com.shop.module.common.exception;

import com.fasterxml.jackson.databind.JsonMappingException;
import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.shop.module.common.domain.ApiError;
...
public class DefaultExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        //Nested Exception : com.fasterxml.jackson.databind.JsonMappingException
        if (ex.getCause() instanceof JsonMappingException){
            log.error("JsonMappingException========== ");
            JsonMappingException e = (JsonMappingException) ex.getCause();
            String jsonMappingExceptionMessage = e.getMessage();
            log.error("getMessage()================== " + jsonMappingExceptionMessage);

            //Nested Exception: java.time.format.DateTimeParseException
            if(e.getCause() instanceof DateTimeParseException){
                ...
                return new ResponseEntity<Object>(new ApiError(HttpStatus.BAD_REQUEST, "Valid Date Format is yyyy-MM-dd", errors), headers, status);
            }


            //Nested Exception: com.fasterxml.jackson.databind.exc.InvalidFormatException
            if(e.getCause() instanceof InvalidFormatException){
                log.error("InvalidFormatException==============");
                InvalidFormatException exception = (InvalidFormatException) e.getCause();
                log.error("getMessage==========" + exception.getMessage());
                return new ResponseEntity<Object>(new ApiError(HttpStatus.BAD_REQUEST, exception.getMessage(), errors), headers, status);

            }

            log.error("Nested Exception Not Any of the Above");
            return new ResponseEntity<Object>(new ApiError(HttpStatus.BAD_REQUEST, jsonMappingExceptionMessage, errors), headers, status);


        }

        return new ResponseEntity<Object>(new ApiError(HttpStatus.BAD_REQUEST, "Exact Exception Not Handled", errors), headers, status);
